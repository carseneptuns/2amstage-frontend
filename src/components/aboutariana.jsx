...
import ar from '../assets/images/artpel.jpg'; // Sesuaikan path gambar Ariana Grande kamu
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div>
                ...
                <span className="font-bold text-gray-100 text-sm md:text-base">NOV, 20 2026</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">WAKTU</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">20.20 WIB</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">VENUE</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">Allianz Ecopark Ancol, Jakarta</span>
              </div>
            </div>
            ...
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed mb-6 max-w-2xl">
              Menghadirkan keanggunan vokal dan kemegahan kelas dunia, Ariana Grande <strong className="text-white font-semibold">Eternal Sunshine Live</strong> — siap memukau Jakarta. Sebuah mahakarya pertunjukan yang memadukan aransemen musik yang megah, harmoni vokal yang hangat, serta nuansa sinematik yang puitis. Satu malam istimewa penuh keajaiban musik yang tak lekang oleh waktu.
            </p>
            ...
            <div className="space-y-3 mb-6">
              {[
                { num: "01", title: "One Last Time" },
                { num: "02", title: "Needy" },
                { num: "03", title: "Intro: The World (extended version)" },
                { num: "04", title: "Into You" },
                { num: "05", title: "God Is Woman" }
              ].map((song, idx) => (
