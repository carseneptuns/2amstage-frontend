  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto h-[90px] px-10 flex items-center justify-between font-midnights">
        ...
        {/* Logo */}
        <h1 className="text-4xl font-black tracking-wide cursor-pointer select-none">
        ...
        <div className="flex items-center gap-8">
          ...
          <button className="px-7 py-2.5 rounded-full border border-white/30 text-white font-medium transition-all duration-300 hover:bg-violet-600 hover:border-violet-600 hover:shadow-[0_0_25px_rgba(139,92,246,.5)]">
            Masuk
          </button>
