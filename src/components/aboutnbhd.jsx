...
import nbhd from '../assets/images/death.jpg'; // Sesuaikan path gambar Ariana Grande kamu
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-300 font-medium text-sm md:text-base">
                WIPED OUT! World Tour<span className="text-gray-600">—</span> Jakarta Night
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div>
                ...
                <span className="font-bold text-gray-100 text-sm md:text-base">DEC, 09 2026</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">WAKTU</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">21.30 WIB</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">VENUE</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">Trans Studio Bandung, Bandung</span>
              </div>
            </div>
            ...
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed mb-6 max-w-2xl">
              Membawa atmosfer melankolis yang sunyi dan distorsi gitar yang membuai, The Neighbourhood <strong className="text-white font-semibold">Wiped Out! World Tour</strong> — siap memukau Jakarta. Sebuah perjalanan sonik penuh nuansa pantai barat yang kelam, aransemen indie rock yang menghanyutkan, serta estetika visual monokromatik yang ikonik. Satu malam penuh nostalgia bagi para pencinta melodi sunyi.
            </p>
            ...
            <div className="space-y-3 mb-6">
              {[
                { num: "01", title: "Sweather Weather" },
                { num: "02", title: "Nervous" },
                { num: "03", title: "Baby Come Home 2 (valentine)" },
                { num: "04", title: "Daddy Issue" },
                { num: "05", title: "OMG" }
              ].map((song, idx) => (
