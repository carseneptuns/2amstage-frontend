...
import jb from '../assets/images/concert.png'; // Sesuaikan path gambar Justin Bieber kamu
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-300 font-medium text-sm md:text-base">
                 SWAG TOUR ASIA<span className="text-gray-600">—</span> Jakarta Night
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div>
                ...
                <span className="font-bold text-gray-100 text-sm md:text-base">OCT, 18 2026</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">WAKTU</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">21.00 WIB</span>
              </div>
              <div>
                <span className="text-[10px] font-mono tracking-wider text-gray-500 block mb-1">VENUE</span>
                <span className="font-bold text-gray-100 text-sm md:text-base">Gelora Bung Karno Madya, Jakarta</span>
              </div>
            </div>
            ...
            <p className="text-gray-400 text-xs md:text-sm leading-relaxed mb-8 max-w-2xl">
              Setelah 10 tahun absen dari panggung Asia Tenggara, Justin Bieber kembali membawa <strong className="text-white font-semibold">SWAG Tour Asia</strong> — sebuah perayaan musik yang memadukan visual panggung mutakhir, gaya busana eksentrik, dan aransemen lagu yang emosional. Satu malam, satu panggung 360°, dan daftar lagu yang disusun ulang khusus untuk Jakarta.
            </p>
            ...
            <div className="mb-8 max-w-xl">
              ...
              <div className="space-y-3">
                {[
                  { num: "01", title: "Daisies" },
                  { num: "02", title: "YUKON" },
                  { num: "03", title: "Everything Hallelujah" },
                  { num: "04", title: "Go Baby" },
                  { num: "05", title: "Walking Away" }
                ].map((song, idx) => (
